...
namespace MovieDatabase.API.Controllers
{
    ...
    public class DirectorsController : ApiController
    {
        ...
        {
            var result = await Mediator.Send(new GetDirectorsQuery 
            { DirectorsResourceParameters = directorsResourceParameters });
        ...
        {
            var result = await Mediator.Send(new GetDirectorByIdQuery
